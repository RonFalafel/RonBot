...
async def rick_roll(ctx, *args):
    ...
    await ctx.send("Now playing \"" + concatMusic1['content'] + "\" at the address \"" + clip + "\"")
...
async def fart(ctx):
    ...
    await play_file_no_disconnect(ctx, "./SoundEffects/farts/" + random.choice(paths))
